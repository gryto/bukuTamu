class ApiService {
  ...
  static String getPieKelamin = "$endPoint/api/countJeniskelaminTamu";
  static String getPieKunjungan = "$endPoint/api/bukutamu/topGuestVisitTypeSummary";
  static String getPieTamuKaryawan = "$endPoint/api/bukutamu/topEmployeeGuestSummary";
  static String getPieTamuAsing= "$endPoint/api/bukutamu/topForeignGuestSummary";
