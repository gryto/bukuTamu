...
class $AssetsIconsGen {
  ...
  AssetGenImage get icKejaksaanLogo =>
      const AssetGenImage('assets/icons/ic_kejaksaanLogo.jpg');
  ...
  /// List of all assets
  List<AssetGenImage> get values => [icKejaksaanLogo, icLauncher, icSerach];
}
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/user_3.jpg
  AssetGenImage get user3 => const AssetGenImage('assets/images/user_3.jpg');

  /// List of all assets
  List<AssetGenImage> get values => [user2, user3];
}
